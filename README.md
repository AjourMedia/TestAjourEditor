...
#### Module 1: Write articles, using paragraph stylesheets and character styles. Save as rtf and html. Send via epost or create your own favorite smtp, ftp and https/rest destination channels.
